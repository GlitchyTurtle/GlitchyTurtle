...
Hey! I'm GlitchyTurtle, and I'm a minecraft bedrock addon developer! Right now, I am working on Avatar Addon and Paradox Anticheat (collaborative bedrock anti-cheat). Check me out om [cpedl](https://mcpedl.com/user/glitchyturtle32/) want to contact me? Your best bet is probably with discord: Glitch#8024

Joined Github **3** years ago.

Since then I pushed **1859**+ commits, opened **229**+ issues, submitted **256**+ pull requests, created **20**+ gists and contributed to **10**+ public repositories.
